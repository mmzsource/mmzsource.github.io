...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__47241 = cljs.core.instance_QMARK_;
var expr__47242 = reactive_val;
if(cljs.core.truth_(pred__47241.call(null,reagent.ratom.RAtom,expr__47242))){
return "ra";
} else {
if(cljs.core.truth_(pred__47241.call(null,reagent.ratom.RCursor,expr__47242))){
return "rc";
} else {
if(cljs.core.truth_(pred__47241.call(null,reagent.ratom.Reaction,expr__47242))){
return "rx";
} else {
if(cljs.core.truth_(pred__47241.call(null,reagent.ratom.Track,expr__47242))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1521280395899
