...
var len__35611__auto___53860 = arguments.length;
var i__35612__auto___53861 = (0);
while(true){
if((i__35612__auto___53861 < len__35611__auto___53860)){
args__35618__auto__.push((arguments[i__35612__auto___53861]));

var G__53862 = (i__35612__auto___53861 + (1));
i__35612__auto___53861 = G__53862;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__35619__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq53858){
var G__53859 = cljs.core.first.call(null,seq53858);
var seq53858__$1 = cljs.core.next.call(null,seq53858);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__53859,seq53858__$1);
});
...
return (p1__53863_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1521280404286
