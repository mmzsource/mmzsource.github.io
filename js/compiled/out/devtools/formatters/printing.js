...
var len__35611__auto___53869 = arguments.length;
var i__35612__auto___53870 = (0);
while(true){
if((i__35612__auto___53870 < len__35611__auto___53869)){
args__35618__auto__.push((arguments[i__35612__auto___53870]));

var G__53871 = (i__35612__auto___53870 + (1));
i__35612__auto___53870 = G__53871;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__35619__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53866){
var G__53867 = cljs.core.first.call(null,seq53866);
var seq53866__$1 = cljs.core.next.call(null,seq53866);
var G__53868 = cljs.core.first.call(null,seq53866__$1);
var seq53866__$2 = cljs.core.next.call(null,seq53866__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__53867,G__53868,seq53866__$2);
});
...
if(cljs.core.truth_((function (){var or__34442__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__35067__auto__,writer__35068__auto__,opt__35069__auto__){
return cljs.core._write.call(null,writer__35068__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__34430__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__34430__auto__){
var or__34442__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53872_SHARP_){
return !((cljs.core.meta.call(null,p1__53872_SHARP_) == null));
})))){
...
var map__53873 = opts;
var map__53873__$1 = ((((!((map__53873 == null)))?((((map__53873.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53873.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53873):map__53873);
var markup_db = cljs.core.get.call(null,map__53873__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__34442__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e53877){var _e__43958__auto__ = e53877;
return false;
}})();
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
...
}catch (e53879){var _e__43958__auto__ = e53879;
return false;
}}
})())){
...
var _STAR_current_state_STAR_53881 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__53882 = opts;
var map__53882__$1 = ((((!((map__53882 == null)))?((((map__53882.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53882.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53882):map__53882);
var markup_db = cljs.core.get.call(null,map__53882__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53881;
}});
...
;
var temp__4655__auto___53886 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___53886)){
var managed_print_level_53887 = temp__4655__auto___53886;
var _STAR_print_level_STAR_53885_53888 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_53887;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_53885_53888,managed_print_level_53887,temp__4655__auto___53886,writer,opts,job_fn){
return (function (p1__53884_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__53884_SHARP_,null);
});})(_STAR_print_level_STAR_53885_53888,managed_print_level_53887,temp__4655__auto___53886,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_53885_53888;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1521280404354
