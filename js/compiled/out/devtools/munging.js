...
var o53738 = temp__4655__auto__;
var temp__4655__auto____$1 = (o53738["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o53739 = temp__4655__auto____$1;
return (o53739["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__43951__auto__ = f;
return (o__43951__auto__["toString"]).call(o__43951__auto__);
} else {
return "";
}
}catch (e53740){var _ = e53740;
return "";
}});
...
try{var o__43951__auto___53742 = t;
(o__43951__auto___53742["cljs$lang$ctorPrWriter"]).call(o__43951__auto___53742,t,writer);
}catch (e53741){var __53743 = e53741;
}
...
var char_code = (function (){var o__43951__auto__ = (new String(char$));
return (o__43951__auto__["charCodeAt"]).call(o__43951__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__43951__auto__ = String;
return (o__43951__auto__["fromCharCode"]).call(o__43951__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__53744 = num_code;
switch (G__53744) {
case (1):
return (185);
...
var o__43951__auto__ = String;
return (o__43951__auto__["fromCharCode"]).call(o__43951__auto__,superscript_code);
});
/**
...
}catch (e53746){var _e__43958__auto__ = e53746;
return false;
}})())){
...
var vec__53747 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__53747,(0),null);
...
var or__34442__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o53750 = temp__4655__auto__;
var temp__4655__auto____$1 = (o53750["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o53751 = temp__4655__auto____$1;
return (o53751["nameToPath"]);
} else {
return null;
}
} else {
...
var len__35611__auto___53758 = arguments.length;
var i__35612__auto___53759 = (0);
while(true){
if((i__35612__auto___53759 < len__35611__auto___53758)){
args__35618__auto__.push((arguments[i__35612__auto___53759]));

var G__53760 = (i__35612__auto___53759 + (1));
i__35612__auto___53759 = G__53760;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__35619__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__53754){
var vec__53755 = p__53754;
var ns_detector = cljs.core.nth.call(null,vec__53755,(0),null);
var effective_detector = (function (){var or__34442__auto__ = ns_detector;
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
...
var G__53761 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__53762 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__53761;
remaining_tokens = G__53762;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq53752){
var G__53753 = cljs.core.first.call(null,seq53752);
var seq53752__$1 = cljs.core.next.call(null,seq53752);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__53753,seq53752__$1);
});
...
var vec__53766 = cljs.core.split_with.call(null,(function (p1__53765_SHARP_){
return cljs.core.not_EQ_.call(null,p1__53765_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__53766,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__53766,(1),null);
...
var vec__53769 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__53769,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__53769,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__53772 = cljs.core.rest.call(null,remaining_tokens);
var G__53773 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__53772;
name_tokens = G__53773;
continue;
} else {
...
var vec__53776 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__53776,(0),null);
var arity = cljs.core.nth.call(null,vec__53776,(1),null);
var vec__53779 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__53779,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__53779,(1),null);
var vec__53782 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__53782,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__53782,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__53782,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__53782,(3),null);
...
var vec__53788 = result;
var munged_ns = cljs.core.nth.call(null,vec__53788,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__53788,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__53788,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__53788,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__53788,(4),null);
var arity = cljs.core.nth.call(null,vec__53788,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__53792 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__53792,(0),null);
var args = cljs.core.nth.call(null,vec__53792,(1),null);
var vec__53795 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__53795,(0),null);
var name = cljs.core.nth.call(null,vec__53795,(1),null);
...
var G__53798 = (arity + (1));
var G__53799 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__53800){
var vec__53801 = p__53800;
var arity = cljs.core.nth.call(null,vec__53801,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__53801,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__34442__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
...
return (function (p1__53804_SHARP_){
return cljs.core.get.call(null,arities,p1__53804_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__53805_SHARP_){
return cljs.core.drop.call(null,(2),p1__53805_SHARP_);
...
var args__35618__auto__ = [];
var len__35611__auto___53812 = arguments.length;
var i__35612__auto___53813 = (0);
while(true){
if((i__35612__auto___53813 < len__35611__auto___53812)){
args__35618__auto__.push((arguments[i__35612__auto___53813]));

var G__53814 = (i__35612__auto___53813 + (1));
i__35612__auto___53813 = G__53814;
continue;
} else {
}
break;
...
var argseq__35619__auto__ = ((((1) < args__35618__auto__.length))?(new cljs.core.IndexedSeq(args__35618__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__35619__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__53808){
var vec__53809 = p__53808;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__53809,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq53806){
var G__53807 = cljs.core.first.call(null,seq53806);
var seq53806__$1 = cljs.core.next.call(null,seq53806);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__53807,seq53806__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__34442__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__34430__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__34442__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
...
var map__53817 = options;
var map__53817__$1 = ((((!((map__53817 == null)))?((((map__53817.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53817.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53817):map__53817);
var include_ns_QMARK_ = cljs.core.get.call(null,map__53817__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__53817__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__53817__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__53817__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__53818 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__53818,(0),null);
var fn_name = cljs.core.nth.call(null,vec__53818,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__53818,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__53818,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__53818,(4),null);
var arity = cljs.core.nth.call(null,vec__53818,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__34430__auto__ = protocol_ns;
if(cljs.core.truth_(and__34430__auto__)){
return cljs.core.not.call(null,(function (){var and__34430__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__34442__auto__ = protocol_part;
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
return fn_part;
...
var o__43951__auto__ = f;
return (o__43951__auto__["getBasis"]).call(o__43951__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__34430__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__34430__auto__)){
...
}catch (e53822){var _e__43958__auto__ = e53822;
...
var G__53823 = (obj[cljs.core.first.call(null,path)]);
var G__53824 = cljs.core.rest.call(null,path);
obj = G__53823;
path = G__53824;
continue;
} else {
...
var partition_bits = (function (){var or__34442__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__34442__auto__)){
return or__34442__auto__;
} else {
return (0);
...
return (function (accum,p__53825){
var vec__53826 = p__53825;
var bit = cljs.core.nth.call(null,vec__53826,(0),null);
var protocol = cljs.core.nth.call(null,vec__53826,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__53829){
var vec__53830 = p__53829;
var ns = cljs.core.nth.call(null,vec__53830,(0),null);
var name = cljs.core.nth.call(null,vec__53830,(1),null);
var selector = cljs.core.nth.call(null,vec__53830,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__53835,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__53835,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__53835,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__53833_SHARP_){
return (obj[cljs.core.first.call(null,p1__53833_SHARP_)]);
});})(name,sorted_matches,vec__53835,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1521280404181
