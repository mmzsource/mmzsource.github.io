...
var or__34442__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj51112 = {"detail":data};
return obj51112;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__34430__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__34430__auto__)){
var and__34430__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__51119 = cljs.core._EQ_;
var expr__51120 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__51119.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__51120))){
return ((function (pred__51119,expr__51120){
return (function (p1__51113_SHARP_){
return console.warn(p1__51113_SHARP_);
});
;})(pred__51119,expr__51120))
} else {
if(cljs.core.truth_(pred__51119.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__51120))){
return ((function (pred__51119,expr__51120){
return (function (p1__51114_SHARP_){
return console.debug(p1__51114_SHARP_);
});
;})(pred__51119,expr__51120))
} else {
if(cljs.core.truth_(pred__51119.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__51120))){
return ((function (pred__51119,expr__51120){
return (function (p1__51115_SHARP_){
return console.error(p1__51115_SHARP_);
});
;})(pred__51119,expr__51120))
} else {
return ((function (pred__51119,expr__51120){
return (function (p1__51116_SHARP_){
return console.log(p1__51116_SHARP_);
});
;})(pred__51119,expr__51120))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__51123){
...
var opts = map__51124__$1;
var eval_fn = cljs.core.get.call(null,map__51124__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__51126_SHARP_){
return new_def.callback(p1__51126_SHARP_);
});})(new_def))
);
...
return (function (p__51127){
var vec__51128 = p__51127;
var ky = cljs.core.nth.call(null,vec__51128,(0),null);
var v = cljs.core.nth.call(null,vec__51128,(1),null);
...
if(cljs.core.truth_((function (){var and__34430__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1521280401063
